...
| **多层 / 心理测量**：ICC 多层 / Likert+α / **保 composite 调信度+CFI** / 因子模型 / IRT 2PL/GRM / 多评分者 / 中介-调节 | `modules/multilevel.md` | `icc_rebuild`, `likertize`, `rebuild_block`, `calibrate_item_reliability`, `sum_preserving_round`, `raw_cronbach_alpha`, `factor_model_sample`, `irt_2pl_data`, `irt_grm_data`, `multi_rater`, `mixed_effects_dataset`, `panel_data` |
