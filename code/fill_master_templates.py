...
def fill_master():
    ...
    panel_c = [
        # (row, low_PD, high_PD, diff, ci, supported)
        (16, -0.024, -0.044, -0.020, _ci_str(-0.041, -0.001), "Yes"),
        (17, -0.021, -0.038, -0.017, _ci_str(-0.036, -0.002), "Yes"),
        (18,  0.011,  0.020,  0.009, _ci_str(-0.001,  0.020), "ns"),
        (19,  0.038,  0.064,  0.026, _ci_str( 0.005,  0.052), "Yes"),
        (20,  0.033,  0.056,  0.023, _ci_str( 0.003,  0.047), "Yes"),
        (21, -0.018, -0.030, -0.012, _ci_str(-0.026,  0.001), "ns"),
    ]
    ...
    panel_d = [
        (24, -0.052, -0.089, -0.037, _ci_str(-0.072, -0.008), "Yes"),
        (25, -0.041, -0.070, -0.029, _ci_str(-0.058, -0.004), "Yes"),
        (26,  0.058,  0.099,  0.041, _ci_str( 0.011,  0.077), "Yes"),
        (27,  0.024,  0.041,  0.017, _ci_str(-0.003,  0.038), "ns"),
        (28,  0.019,  0.033,  0.014, _ci_str(-0.002,  0.032), "ns"),
        (29, -0.027, -0.046, -0.019, _ci_str(-0.041,  0.001), "ns"),
    ]
    ...
    panel_e = [
        (32, -0.030, -0.034, -0.004, _ci_str(-0.025,  0.018), "ns"),
        (33, -0.026, -0.029, -0.003, _ci_str(-0.022,  0.016), "ns"),
        (34,  0.014,  0.016,  0.002, _ci_str(-0.012,  0.017), "ns"),
        (35,  0.048,  0.054,  0.006, _ci_str(-0.014,  0.026), "ns"),
        (36,  0.041,  0.046,  0.005, _ci_str(-0.013,  0.024), "ns"),
        (37, -0.022, -0.025, -0.003, _ci_str(-0.020,  0.014), "ns"),
    ]
    ...
    panel_f = [
        (40, -0.067, -0.073, -0.006, _ci_str(-0.028,  0.015), "ns"),
        (41, -0.054, -0.058, -0.004, _ci_str(-0.022,  0.014), "ns"),
        (42,  0.075,  0.082,  0.007, _ci_str(-0.014,  0.029), "ns"),
        (43,  0.031,  0.034,  0.003, _ci_str(-0.014,  0.020), "ns"),
        (44,  0.025,  0.027,  0.002, _ci_str(-0.013,  0.018), "ns"),
        (45, -0.035, -0.038, -0.003, _ci_str(-0.022,  0.015), "ns"),
    ]
